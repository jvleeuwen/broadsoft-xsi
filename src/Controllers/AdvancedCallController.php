...
namespace Jvleeuwen\BroadsoftXSI\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Jvleeuwen\BroadsoftXSI\Events\BroadsoftXSIEvent;
...
//        event(new AdvancedCallEvent($CallAnsweredEvent));
        event(new BroadsoftXSIEvent($CallAnsweredEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallBargedInEvent));
        event(new BroadsoftXSIEvent($CallBargedInEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallCollectingEvent));
        event(new BroadsoftXSIEvent($CallCollectingEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallForwardedEvent));
        event(new BroadsoftXSIEvent($CallForwardedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallHeldEvent));
        event(new BroadsoftXSIEvent($CallHeldEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallOriginatedEvent));
        event(new BroadsoftXSIEvent($CallOriginatedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallOriginatingEvent));
        event(new BroadsoftXSIEvent($CallOriginatingEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallPickedUpEvent));
        event(new BroadsoftXSIEvent($CallPickedUpEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallReceivedEvent));
        event(new BroadsoftXSIEvent($CallReceivedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallRecordingStartedEvent));
        event(new BroadsoftXSIEvent($CallRecordingStartedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallRecordingStoppedEvent));
        event(new BroadsoftXSIEvent($CallRecordingStoppedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallRedirectedEvent));
        event(new BroadsoftXSIEvent($CallRedirectedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallReleasedEvent));
        event(new BroadsoftXSIEvent($CallReleasedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallReleasingEvent));
        event(new BroadsoftXSIEvent($CallReleasingEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallRetrievedEvent));
        event(new BroadsoftXSIEvent($CallRetrievedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallSubscriptionEvent));
        event(new BroadsoftXSIEvent($CallSubscriptionEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallTransferredEvent));
        event(new BroadsoftXSIEvent($CallTransferredEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($CallUpdatedEvent));
        event(new BroadsoftXSIEvent($CallUpdatedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($ConferenceHeldEvent));
        event(new BroadsoftXSIEvent($ConferenceHeldEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($ConferenceReleasedEvent));
        event(new BroadsoftXSIEvent($ConferenceReleasedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($ConferenceRetrievedEvent));
        event(new BroadsoftXSIEvent($ConferenceRetrievedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($ConferenceStartedEvent));
        event(new BroadsoftXSIEvent($ConferenceStartedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($ConferenceUpdatedEvent));
        event(new BroadsoftXSIEvent($ConferenceUpdatedEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($HookStatusEvent));
        event(new BroadsoftXSIEvent($HookStatusEvent));
        return Null;
    }
...
//        event(new AdvancedCallEvent($SubscriptionTerminatedEvent));
        event(new BroadsoftXSIEvent($SubscriptionTerminatedEvent));
        return Null;
    }
}
