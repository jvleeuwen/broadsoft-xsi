...
use Jvleeuwen\BroadsoftXSI\Repositories\Contracts\BsUserInterface;
//use Jvleeuwen\BroadsoftXSI\Controllers\EmailController;
...
class CallCenterAgentController extends Controller
{
    ...
    */
    protected function ACDAgentJoinUpdateEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDAgentJoinUpdateEvent));
        return Null;
    }
    ...
    */
    protected function AgentStateEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($AgentStateEvent));
    ...
    */
    protected function AgentSubscriptionEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($AgentSubscriptionEvent));
        return Null;
    }
