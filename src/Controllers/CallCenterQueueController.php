...
class CallCenterQueueController extends Controller
{
    ...
    */
    protected function ACDCallAbandonedEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallAbandonedEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallAddedEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallAddedEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallAnsweredByAgentEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallAnsweredByAgentEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallBouncedEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallBouncedEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallOfferedToAgentEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallOfferedToAgentEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallOverflowedEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallOverflowedEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallOverflowedTreatmentCompletedEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallOverflowedTreatmentCompletedEvent));
        return Null;
    }
    ...
    */
    protected function ACDCallTransferredEvent($xml)
    {
        ...
        event(new BroadsoftXSIEvent($ACDCallTransferredEvent));
        return Null;
    }
